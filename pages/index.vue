        ...
        >
          ...
          >
            <nuxt-link to="/ai-copilot">
              <div class="mt-1 mb-5">
                <span class="rounded-full bg-gray-100 hover:bg-gray-200 border border-gray-300 px-3 pl-2 py-1 text-sm cursor-pointer">
                  <mdicon name="star-four-points-outline" class="mr-1" size="18" />
    ...
    <div class="py-16 md:py-24 bg-ui-secondary-25">
      <div class="container flex flex-col md:flex-row">
        ...
        >
          ...
          <div
            class="font-medium mb-4 w-full text-left">
        ...
        <div class="flex-2 order-1 md:order-2">
          <div class="card h-full transition-shadow flex shadow-lg overflow-hidden">
